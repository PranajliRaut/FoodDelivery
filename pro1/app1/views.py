...
from .models import Contact, Dish, Team, Category, Profile, Order
...
def dish_detail(request, dish_id):
    ...
    # Assuming `dish.ingredients` is a comma-separated string
    ingredients_list = dish.ingredients.split(',')
    return render(request, 'your_template.html', {'dish': dish, 'ingredients_list': ingredients_list})
